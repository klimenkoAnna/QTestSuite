...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SUTestsList_t, stringdata0) + ofs \
...
void SUTestsList::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SUTestsList::GoToSUTestResults)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SUTestsList::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SUTestsList::GoToSUTestEdit)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SUTestsList::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SUTestsList::GoToLoginWnd)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject SUTestsList::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SUTestsList.data,
      qt_meta_data_SUTestsList,  qt_static_metacall, nullptr, nullptr}
};
...
void *SUTestsList::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SUTestsList.stringdata0))
