...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SUTestResults_t, stringdata0) + ofs \
...
void SUTestResults::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SUTestResults::GoToSUStudentInfo)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (SUTestResults::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SUTestResults::GoToSUTestsLits)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (SUTestResults::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SUTestResults::GoToSUStudResults)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject SUTestResults::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SUTestResults.data,
      qt_meta_data_SUTestResults,  qt_static_metacall, nullptr, nullptr}
};
...
void *SUTestResults::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SUTestResults.stringdata0))
