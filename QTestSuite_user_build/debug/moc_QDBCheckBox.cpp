...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QDBCheckBox_t, stringdata0) + ofs \
...
void QDBCheckBox::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QDBCheckBox::clickedNum)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QDBCheckBox::staticMetaObject = {
    { &QCheckBox::staticMetaObject, qt_meta_stringdata_QDBCheckBox.data,
      qt_meta_data_QDBCheckBox,  qt_static_metacall, nullptr, nullptr}
};
...
void *QDBCheckBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QDBCheckBox.stringdata0))
