...
static int GetVariables(
  ...
  struct lhsParseNode *thePattern)
  {
   ...
   /*======================================================*/
   /* Loop through all the fields/c_slots found in a pattern */
...
static int ProcessVariable(
  ...
  struct lhsParseNode *patternHead)
  {
   ...
   /*=================================================================*/
   /* Propagate the constraints to other fields, c_slots, and patterns. */
   /*=================================================================*/
...
static int PropagateVariableDriver(
  ...
  int assignReference)
  {
   ...
   /*========================================================*/
   /* Propagate the variable location to fields/c_slots in the */
...
static int ProcessField(
  ...
  struct lhsParseNode *patternHead)
  {
   ...
   /* propagated to other c_slots and fields.                              */
   /*====================================================================*/
