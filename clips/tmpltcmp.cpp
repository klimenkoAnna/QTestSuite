...
static int ConstructToCode(
  ...
  int maxIndices)
  {
   ...
   /* the deftemplate c_slots writing their C code representation   */
      ...
      while (theTemplate != NULL)
        {
         ...
         /*======================================================*/
         /* Loop through each of the c_slots for this deftemplate. */
         /*======================================================*/
...
static void DeftemplateToCode(
  ...
  int slotCount)
  {
   ...
   /* Number of c_slots, and Busy Count.         */
   /*==========================================*/

   fprintf(theFile,"%d,0,0,%d,%ld,",theTemplate->implied,theTemplate->numberOfc_slots,theTemplate->busyCount);
