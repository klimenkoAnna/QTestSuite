...
/***************************************/
   ...
   static struct lhsParseNode       *RemoveUnneededc_slots(void *,struct lhsParseNode *);
...
static struct patternNodeHeader *PlaceFactPattern(
  ...
  struct lhsParseNode *thePattern)
  {
   ...
   thePattern->right = RemoveUnneededc_slots(theEnv,thePattern->right);
...
/*************************************************************/
/* RemoveUnneededc_slots: Removes fact pattern nodes that have */
...
/*   all foo facts will have these two c_slots in the fact     */
/*   data structure used to store them.                      */
/*************************************************************/
static struct lhsParseNode *RemoveUnneededc_slots(
  void *theEnv,
  struct lhsParseNode *thePattern)
  {
   ...
   while (tempPattern != NULL)
     {
      ...
      /*===================================================*/
      /* Recursively call RemoveUnneededc_slots for the slot */
      ...
      /*===================================================*/
               ...
               (tempPattern->multifieldSlot == TRUE))
        {
         ...
         tempPattern->bottom = RemoveUnneededc_slots(theEnv,tempPattern->bottom);
...
static struct factPatternNode *CreateNewPatternNode(
  ...
  unsigned constantSelector)
  {
   ...
   /* its c_slots to the default values.       */
   /*========================================*/
