...
#pragma unused(theEnv,vTheConstruct)
   ...
   /*===========================================*/
   /* Free storage used by the templates c_slots. */
   /*===========================================*/
   ...
   Returnc_slots(theEnv,theConstruct->slotList);
...
/***********************************************/
/* Returnc_slots: Returns the slot structures of */
/*   a deftemplate to free memory.             */
/***********************************************/
globle void Returnc_slots(
  void *theEnv,
  struct templateSlot *slotPtr)
  {
#if (MAC_MCW || WIN_MCW) && (RUN_TIME || BLOAD_ONLY)
