...
#define Deftemplatec_slotsingleP(a,b) EnvDeftemplatec_slotsingleP(GetCurrentEnvironment(),a,b)
...
#define DeftemplateSlotDefaultP(a,b) EnvDeftemplateSlotDefaultP(GetCurrentEnvironment(),a,b)
   ...
   LOCALE int                            Deftemplatec_slotsinglePFunction(void *);
   LOCALE int                            EnvDeftemplatec_slotsingleP(void *,void *,char *);
