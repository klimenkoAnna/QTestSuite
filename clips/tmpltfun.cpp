...
globle void DeftemplateFunctions(
  void *theEnv)
  {
   ...
   EnvDefineFunction2(theEnv,"deftemplate-slot-singlep",'b',PTIEF Deftemplatec_slotsinglePFunction,
                   "Deftemplatec_slotsinglePFunction","22w");
   ...
   while (testPtr != NULL)
     {
      ...
      /* the slot against the list of c_slots for the deftemplate.    */
      /*============================================================*/
...
globle int EnvDeftemplateSlotDefaultP(
  ...
  char *slotName)
  {
   ...
   /* list of c_slots defined for the deftemplate. */
   /*============================================*/
...
/******************************************************/
/* Deftemplatec_slotsinglePFunction: H/L access routine */
/*   for the deftemplate-slot-singlep function.       */
/******************************************************/
globle int Deftemplatec_slotsinglePFunction(
  void *theEnv)
  {
   struct deftemplate *theDeftemplate;
   SYMBOL_HN *slotName;
   ...
   return EnvDeftemplatec_slotsingleP(theEnv,theDeftemplate,ValueToString(slotName));
  }

/************************************************/
/* EnvDeftemplatec_slotsingleP: C access routine  */
/*   for the deftemplate-slot-singlep function. */
/************************************************/
globle int EnvDeftemplatec_slotsingleP(
  void *theEnv,
  void *vTheDeftemplate,
  char *slotName)
  {
...
/*   c_slots for replacement are stored rather than the slot     */
/*   name which allows quicker replacement of c_slots. This      */
...
/*   until you actually do the replacement of c_slots).          */
/***************************************************************/
   ...
   while (theToken.type != RPAREN)
     {
      ...
      /*=========================================*/
      /* Add the slot name to the list of c_slots. */
      /*=========================================*/
