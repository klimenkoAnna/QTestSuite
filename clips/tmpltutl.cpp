...
globle void CheckTemplateFact(
  ...
  struct fact *theFact)
  {
   ...
   /*=============================================*/
   /* Check each of the c_slots of the deftemplate. */
   /*=============================================*/
...
globle intBool CheckRHSSlotTypes(
  ...
  char *thePlace)
  {
   ...
   if (EnvGetStaticConstraintChecking(theEnv) == FALSE) return(TRUE);
      rv = ConstraintCheckExpressionChain(theEnv,rhsc_slots,slotPtr->constraints);
      if (rv != NO_VIOLATION)
        {
...
globle void PrintTemplateFact(
  ...
  int ignoreDefaults)
  {
   ...
   /*===================================================*/
   /* Print each of the field c_slots of the deftemplate. */
   /*===================================================*/
   ...
   while (slotPtr != NULL)
     {         
      /*=================================================*/
      /* If we're ignoring c_slots with their original     */
