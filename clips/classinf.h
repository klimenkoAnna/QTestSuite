...
#define Classc_slots(a,b,c) EnvClassc_slots(GetCurrentEnvironment(),a,b,c)
...
#define c_slotsources(a,b,c) Envc_slotsources(GetCurrentEnvironment(),a,b,c)
...
LOCALE void Classc_slotsCommand(void *,DATA_OBJECT *);
...
LOCALE void c_slotsourcesCommand(void *,DATA_OBJECT *);
...
#endif
LOCALE void EnvClassc_slots(void *,void *,DATA_OBJECT *,int);
...
LOCALE void Envc_slotsources(void *,void *,char *,DATA_OBJECT *);
