...
/*            properly handle defaults for multifield c_slots. */
/*            DR0869                                         */
/*                                                           */
...
/*   all of the fact's c_slots or fields.           */
/**************************************************/
...
globle struct fact *EnvCreateFact(
  ...
  void *vTheDeftemplate)
  {
   ...
   if (theDeftemplate->implied == FALSE)
     {
      newFact = CreateFactBySize(theEnv,theDeftemplate->numberOfc_slots);
      for (i = 0;
           i < (int) theDeftemplate->numberOfc_slots;
           i++)
...
/*   structure based on the number of c_slots. */
/*********************************************/
