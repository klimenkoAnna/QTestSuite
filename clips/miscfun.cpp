...
globle void MiscFunctionDefinitions(
  void *theEnv)
  {
   ...
   EnvDefineFunction2(theEnv,"new",'u', PTIEF NewFunction,"NewFunction","22*wk"); /* TBD (new java HashMap ...) */
...
globle void NewFunction(
  ...
  DATA_OBJECT *returnValue)
  {
   ...
   for (theType = 0; theType < EvaluationData(theEnv)->numberOfAddressTypes; theType++)
     {
      if (strcmp(EvaluationData(theEnv)->ExternalAddressTypes[theType]->name,name) == 0)
        {
         found = TRUE;
         break;
        }
