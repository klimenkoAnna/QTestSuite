...
/*   the values of two single field c_slots.                  */
/************************************************************/
#if WIN_BTC
#pragma argsused
#endif
...
/*   comparing the values of two single field c_slots. */
/*****************************************************/
...
#pragma unused(theEnv)
   ...
   for (;
     ...
     {
      /*===============================================*/
      /* Skip over multifield markers for other c_slots. */
      /*===============================================*/
