...
globle void SetupInstances(
  void *theEnv)
  {
   ...
   EnvDefineFunction2(theEnv,"init-c_slots",'u',PTIEF Initc_slotsCommand,"Initc_slotsCommand","00");
      ...
      if (tmpIPtr->cls->instanceSlotCount != 0)
        {
         ...
         if (tmpIPtr->cls->localInstanceSlotCount != 0)
           {
            rm(theEnv,(void *) tmpIPtr->c_slots,
...
/***************************************************
  NAME         : PrintInstance
  DESCRIPTION  : Displays an instance's c_slots
